...
config. BgColor			= '#e6f1fd'	// Background colour (HTML colour value, in quotes)
config. BgImg			= ''		// Path to background image, none if empty string ''
config. BorderColor		= '#e6f1fd'
config. BorderStyle		= 'dotted'	// Any permitted CSS value, but I recommend 'solid', 'dotted' or 'dashed'
config. BorderWidth		= 1
config. CenterMouse		= true		// April 2017. false or true - center the tip horizontally below (or above) the mousepointer
config. ClickClose		= false		// false or true - close tooltip if the user clicks somewhere
config. ClickSticky		= false		// false or true - make tooltip sticky if user left-clicks on the hovered element while the tooltip is active
config. CloseBtn		= false		// false or true - closebutton in titlebar
config. CloseBtnColors	= ['#e6f1fd', '#acd2ec', '#e3c3c3', '#FFFFFF']	// [Background, text, hovered background, hovered text] - use empty strings '' to inherit title colours
...
config. FontColor		= '#13467b'
config. FontFace		= 'Arial, Tahoma, Verdana,Geneva,sans-serif'
...
config. TitleFontColor	= '#68a0d9'	// Color of title text - if '', BgColor (of tooltip body) will be used
